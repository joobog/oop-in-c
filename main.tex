...
\begin{missing}{Zugriffskontrolle}
	 Keine Zugriffskontrolle
		 \begin{itemize}
			 \item Alle Variablen und Methoden sind \mintinline{C}|public|
			 \item Nachbildung von \mintinline{C}|protected| \mintinline{C}|private| nicht ohne weiteres möglich
		 \end{itemize}
\end{missing}
...
%  Component super;
%  char num_of_connectors;
%};

%struct Infiniband {
%  NetworkAdapter super;
%  int num_of_links;
%};
