...
\setminted{style=monokai, fontsize=\small, bgcolor=bg, linenos, tabsize=2}
...
%\input{02_classes_plain}
%\input{03_1_classes_virt_cpp}
\input{03_2_classes_virt_c}
%\input{05_best_practices}
